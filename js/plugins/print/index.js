...
const {setPrintParameter, changePrintZoomLevel, changeMapPrintPreview, printCancel} =
    require('@mapstore/actions/print');
...
})(require('@mapstore/components/print/Choice'));
...
})(require('@mapstore/components/print/Sheet'));

const {currentLayouts, twoPageEnabled} = require('@mapstore/selectors/print');
...
})(require('@mapstore/components/print/PrintOption'));
...
})(require('@mapstore/components/print/PrintOptions'));
...
})(require('@mapstore/components/print/Font'));
...
})(require('@mapstore/components/print/MapPreview'));

const PrintSubmit = connect((state) => ({
    loading: state.print && state.print.isLoading || false
}))(require('@mapstore/components/print/PrintSubmit'));
