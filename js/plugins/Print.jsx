...
const {printSubmit, printSubmitting, configurePrintMap} = require('@mapstore/actions/print');

const {mapSelector} = require('@mapstore/selectors/map');
const {layersSelector} = require('@mapstore/selectors/layers');
...
const {scalesSelector} = require('@mapstore/selectors/map');
...
require('@mapstore/plugins/print/print.css');
...
module.exports = {
    PrintPlugin: assign({
        loadPlugin: (resolve) => {
            require.ensure('@mapstore/plugins/print/index', () => {
                const {
                    Name,
                    Description,
                    Resolution,
    ...
    reducers: {print: require('@mapstore/reducers/print')}
};
