...
const DropdownToolbarOptions = require('@mapstore/components/misc/toolbar/DropdownToolbarOptions');
const CoordinateEntry = require('@mapstore/components/misc/coordinateeditors/CoordinateEntry');
