            ...
            return (
                <div>
                    <div style={this.props.style}>
                        <ReactPDF file={this.props.url.replace("http", "https")} scale={this.props.scale} pageIndex={this.props.currentPage} onDocumentLoad={this.onDocumentComplete}/>
                    </div>
                    <div style={{marginTop: "10px"}}>
                        ...
                        <div className={"print-download btn btn-" + this.props.buttonStyle}><a href={this.props.url.replace("http", "https")} target="_blank"><Glyphicon glyph="save"/></a></div>
